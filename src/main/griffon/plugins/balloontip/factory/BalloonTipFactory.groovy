...
package griffon.plugins.balloontip.factory
...
class BalloonTipFactory extends AbstractFactory {
   ...
   protected BalloonTip newBalloonTip( builder, name, component, text, attributes ) {
      ...
      JComponent contents = attributes.remove("contents")
      if(text != null && contents == null) contents = new JLabel(text)
      ...
      return new BalloonTip(component, contents, style, alignment, attachLocation,
            horizontalOffset as int, verticalOffset as int, useCloseButton)
   }
...
class CustomBalloonTipFactory extends BalloonTipFactory {
   protected BalloonTip newBalloonTip( builder, name, component, text, attributes ) {
      ...
      return new CustomBalloonTip(component, contents, offset, style, alignment, attachLocation,
            horizontalOffset as int, verticalOffset as int, useCloseButton)
   }
}
...
class TablecellBalloonTipFactory extends BalloonTipFactory {
   protected BalloonTip newBalloonTip( builder, name, component, text, attributes ) {
      ...
      if(positioner == null) {
         return new CustomBalloonTip(component, contents, row as int, column as int, style, alignment, attachLocation,
            horizontalOffset as int, verticalOffset as int, useCloseButton)
      } else {
         return new CustomBalloonTip(component, contents, offset, style, positioner, useCloseButton)       
      }
   }
}
